...
**If you are the publisher of the project:** Charging for technical support services that are closely associated with the supply of the software can constitute monetisation, which would make the software a product placed on the market. However, this only applies where the price charged _"does not serve only the recuperation of actual costs"_ ([[Recital 15]]). If you're a natural person and the fees only cover costs related to design, development, and maintenance—including reasonable living expenses—this alone would not make you a manufacturer. If you're a legal person that meets the definition of open-source software steward, you would be subject to steward obligations rather than manufacturer obligations for the non-monetised version of the software.
...
See also: [[maintainers/living-expenses]] and [[manufacturers/service-providers]].
