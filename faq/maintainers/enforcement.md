...
Escalation is most likely if a maintainer who qualifies as a manufacturer ignores known vulnerabilities, misrepresents the security status of their software, or repeatedly fails to cooperate with authority requests. When penalties are imposed on natural persons or small entities, authorities must consider _"the economic situation"_ and _"size"_ of the entity ([[Recital 121]]; [[Article 64]]). Additionally, [microenterprises and small enterprises](https://single-market-economy.ec.europa.eu/smes/sme-fundamentals/sme-definition_en) are explicitly exempt from fines for failing to meet the 24-hour early warning notification deadline ([[Article 64(10)(b)]]).

For more details on potential penalties, see [[maintainers/penalties]].
